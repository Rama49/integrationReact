    ...
    return(
        <section className="row m-0 g-0 brand">
            <div className="col-lg-6 col-sm-12 col-md-12 p-5">
                <h1 className="pt-5 mb-5 titlebrand m-0 p-0">Transform your brand</h1>
                <p className="parabrand">We are a full-service ceative agency specializing in helping brands grow fast
